...
<div class="form-group">
    ...
    <select id="studentId" name="studentId" class="form-control" required>
        ...
        <c:forEach var="student" items="${studentList}">
            <option value="${student.id}" data-class="${student.className}">
...
<div class="form-group">
    ...
    <input type="text" id="classId" name="classId" class="form-control" readonly>
</div>
...
<script>
    document.getElementById("studentId").addEventListener("change", function() {
        ...
        // Lấy dữ liệu lớp học từ thuộc tính data-class
        const className = selectedOption.getAttribute("data-class");
        // Gán giá trị vào input lớp học
